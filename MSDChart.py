...
class BodeWindow(QWidget):
    def __init__(self):
        ...
        self.plot_widget_1.setTitle("Amplitude vs. Frequency", color='black')
        ...
        self.plot_widget_2.setTitle("Phase vs. Frequency", color='black')
        ...
        self.plot_widget_3.setTitle("unControl vs. Control", color='black')
        self.plot_widget_3.setLabel('left', 'Amplitude (dB)', color='black')
